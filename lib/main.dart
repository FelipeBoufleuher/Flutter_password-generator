...
class GeradorSenhasAppState extends State<GeradorSenhasApp> {
  ...
  void forcaSenha() {
    if (maiuscula && minusculas && numeros && caracterespecial && range > 15) {
      setState(() {
        passwordStrength = "Forte";
      });
    } else if (range > 8 && minusculas && numeros || ( range > 8 && maiuscula && minusculas && numeros && caracterespecial)) {
      setState(() {
